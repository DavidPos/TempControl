 ...
 */
public class ParticleCloudAltSDK {
        ...
        public static void initWithOauthCredentialsProvider(
                @NonNull Context ctx, @Nullable ApiFactory.OauthBasicAuthCredentialsProvider oauthProvider) {
        ...
        static void initWithSdkProvider(SDKProvider sdkProvider) {
            ...
            instance = new ParticleCloudAltSDK(sdkProvider);
        }
        ...
        private ParticleCloudAltSDK(SDKProvider sdkProvider) {
