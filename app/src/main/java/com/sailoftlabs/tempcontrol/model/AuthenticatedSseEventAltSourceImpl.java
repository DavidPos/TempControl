 ...
 */
public class AuthenticatedSseEventAltSourceImpl extends SseEventSourceImpl{
    /**
    ...
    // FIXME: replace this entire SSE stack with something backed by OkHttp.
        ...
        private static final String _CLASS_NAME = AuthenticatedSseEventAltSourceImpl.class.getName();
        private static final TLog _LOG = TLog.get(AuthenticatedSseEventAltSourceImpl.class);
        ...
        private final SseEventReaderAltImpl _eventReader;
        ...
        private ParticleAltCloud cloud;

        public AuthenticatedSseEventAltSourceImpl(URI location, ParticleAltCloud cloud) {
            super(location);
            this.cloud = cloud;
            ...
            _eventReader = new SseEventReaderAltImpl(this, _sharedQueue);
        }
        ...
        public synchronized void connect() throws IOException {
            ...
            _eventStream = new AuthenticatedSseEventAltStream(_location.toString(), cloud);
