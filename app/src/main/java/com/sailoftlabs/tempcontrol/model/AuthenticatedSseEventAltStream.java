 ...
 */
public class AuthenticatedSseEventAltStream extends SseEventStream{
        ...
        public AuthenticatedSseEventAltStream(String sseLoc, ParticleAltCloud cloud) throws IOException {
            super(sseLoc);
        ...
        public void connect() throws IOException {
            ...
            try {
                ...
                sseSource = new HttpRequest(HttpRequest.Method.GET, uri, true);
