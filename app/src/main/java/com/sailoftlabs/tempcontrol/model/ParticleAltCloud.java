...
/**
 * Created by davidpos on 1/21/16.
 */
@SuppressWarnings({"UnusedDeclaration"})
public class ParticleAltCloud {
    ...
    private final EventDelegate eventsDelegate;
...
//    @Nullable
    ...
    ParticleAltCloud(@NonNull Uri schemeAndHostname,
        ...
        this.eventsDelegate = new EventDelegate(mainApi, schemeAndHostname, gson, executor, this);
    }
